      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r-2 group-data-[side=left]:border-gray-500 group-data-[side=right]:border-l-2 group-data-[side=right]:border-gray-500",
          className
        )}
        {...props}
      >
